...
export const SAVE_HAS_PLATE_NUMBER = 'SAVE_HAS_PLATE_NUMBER'
export const SAVE_PLATE_NUMBER = 'SAVE_PLATE_NUMBER'
export const INIT_HAS_PLATE_NUMBER = 'INIT_HAS_PLATE_NUMBER'
export const INIT_PLATE_NUMBER = 'INIT_PLATE_NUMBER'

export const SAVE_FRAME_NUMBER = 'SAVE_FRAME_NUMBER'
export const SAVE_MODEL = 'SAVE_MODEL'
export const SAVE_ORDER_NUMBER = 'SAVE_ORDER_NUMBER'
export const INIT_ORDER_NUMBER = 'INIT_ORDER_NUMBER'
export const SAVE_IDENTIFY_NUMBER = 'SAVE_IDENTIFY_NUMBER'
export const SAVE_QUOTED_PRICE = 'SAVE_QUOTED_PRICE'
